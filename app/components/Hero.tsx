...
const Hero = () => {
  return (
    <section className="relative min-h-[60vh] md:min-h-[70vh] pt-20 md:pt-28 pb-8 md:pb-16 px-2 md:px-6 lg:px-8 flex items-center bg-[#F2F4F6]">
      ...
      <div className="w-full md:w-[95%] mx-auto relative rounded-2xl overflow-hidden hidden sm:block">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center">
          <div className="px-4 md:px-12 py-8 md:py-0 max-w-2xl -mt-8 md:-mt-12 ml-4 md:ml-8">
            <h1 className="text-white font-grange font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight sm:leading-snug md:leading-tight lg:leading-tight tracking-[0%] mb-3 md:mb-5">
      ...
      {/* Mobile version with responsive background image */}
      <div className="w-full mx-auto relative rounded-2xl overflow-hidden block sm:hidden min-h-[400px] max-h-[500px]">
        <Image 
          src="/images/respbg.png"
          alt="hero mobile"
          width={400}
          height={400}
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center">
          <div className="px-4 py-8 max-w-2xl mx-auto">
            <h1 className="text-white font-grange font-extrabold text-xl sm:text-2xl leading-tight mb-3">
              Découvrez l'excellence dans les sciences islamiques
            </h1>

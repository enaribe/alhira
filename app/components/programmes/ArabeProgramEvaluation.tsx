  ...
  sections: [
    {
      ...
      description: "Évaluations orales et écrites régulières pour mesurer la progression et l'assimilation des connaissances linguistiques.",
    },
    {
    ...
    },
    {
      title: 'Certification',
      icon: '/assets/icons/star.svg',
      description: "Certificat final de la Faculté de Langue Arabe délivré aux étudiants ayant validé avec succès les trois niveaux d'études.",
    },
  ],
};
...
export default ArabeProgramEvaluation; 
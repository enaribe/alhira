  ...
  return (
    <header className="relative h-[200px] md:h-[255px] rounded-3xl overflow-hidden shadow-lg">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full p-6 md:p-12 text-white">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-grange">{title}</h1>
        <p className="mt-2 md:mt-4 text-sm sm:text-base md:text-lg lg:text-xl max-w-full md:max-w-lg lg:max-w-2xl">
          {description}
        </p>
      </div>
    </header>
